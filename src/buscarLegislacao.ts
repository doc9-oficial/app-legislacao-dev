...
interface BuscarLegislacaoParams {
  termo: string;
  filtro?: string;
}

async function buscarLegislacao(params: BuscarLegislacaoParams): Promise<void> {
  try {
    ...
    console.log(`Executando buscarLegislacao com termo=${params.termo}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Busca leis e normativas por palavra-chave concluído com sucesso",
      resultado: {
...
export default buscarLegislacao;
