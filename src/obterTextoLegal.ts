...
interface ObterTextoLegalParams {
  parametro: string;
  filtro?: string;
}

async function obterTextoLegal(params: ObterTextoLegalParams): Promise<void> {
  try {
    ...
    console.log(`Executando obterTextoLegal com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Obtém texto completo de lei específica concluído com sucesso",
      resultado: {
...
export default obterTextoLegal;
